...
var circleHighlight = {color:'#fc1303', stroke:5}; //game circle highlight settings
var statusPuzzleComplete = 'COMPLETE'; //game status when complete
var statusPuzzleTimer = 'TIME\'S UP'; //game status when time's up

var resultTitle = 'GAME OVER!'; //game result title
var resultDesc = ''; //game result description
...
function buildGameButton(){
	...
	buttonContinue.addEventListener("click", function(evt) {
		playSound('soundClick');
		window.location.href = "https://www.sjptae.com/industryzone";
	});
